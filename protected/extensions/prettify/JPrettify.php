...
class JPrettify extends CWidget
{
    ...
    protected function setLang($language)
    {
        ...
        if (!array_key_exists($this->_lang,self::$languageFileExtensions))
            throw new CException(Yii::t(__CLASS__,'Invalid language: {value}.', array('{value}'=>$this->_lang)));
    }
	...
	public function init()
	{
		...
		Yii::app()->getClientScript()
           ...
           ->registerScriptFile($extension,CClientScript::POS_HEAD)
           ->registerScript('JPrettify',$js, CClientScript::POS_READY)
           ->registerCssFile($url);
